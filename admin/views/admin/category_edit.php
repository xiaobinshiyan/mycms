...
<body>
	<div class="wrap">
	   ...
	   <form action="<?php echo site_url('welcome/category_edit/'.$cates['cid']); ?>" method="post">
		   	<table class="table1 hd-form">
		   	 ...
		   	 <tr>
		   		...
		   		<select name="pid" class="w200">
		   		    ...
		   		    <?php foreach ($category as $k => $v): ?>
		   		    	<option value="<?php echo $v['cid'] ?>" <?php if($cates['pid'] == $v['cid']): ?>selected='selected' <?php endif; ?>>
		   	 ...
		   	 <tr>
                 ...
                 <?php if($cates['cattype'] == 2): ?>
		   	 	...
		   	 	<?php else: ?>
		   	 		<input type="radio" name="cattype" checked value="1" id="article" /><label for="article">普通文章</label>

		   	 		<input type="radio" name="cattype" value="2" id="others" /><label for="others">其他</label>
		   	    <?php endif; ?>
		   	  ...
		   	  <tr>
		   		...
		   		<td>
		   		   <input type="text" name="catname" value="<?php echo $cates['catname'] ?>" style="width:185px;"/>
		   		</td>
		   	 </tr>
		   	 ...
		   	 <tr>
		   	    ...
		   	    <td>
                    <!-- 上传图片插件 -->
		   	 	    <div class = 'ad_upload_input'>
		   	 	      	<input id="catimage" type="text" name="image" readonly onmouseover='view_image(this)' src='' value="<?php echo $cates['catimage'] ?>" style="width:185px;opacity:0.5" nctype="file_21">
		   	 	    </div>
	   	  	  ...
	   	  	  <tr>
	   	   		...
	   	   		<td>
	   	   		   <input type="text" name="seo_title" value="<?php echo $cates['seo_title'] ?>" style="width:318px;"/>
	   	   		</td>
	   	   	 </tr> 	
	         ...
	         <tr>
	   		    ...
	   		    <td>
	   			   <textarea name="seo_description" id= ""cols="50" rows="6"><?php echo $cates['seo_description'] ?></textarea>
	   		    </td>
		     </tr>
			...
			<tr>
		   	    <th class='w100'>排序</th>
		   		<td>
		   			<input type="text" name="sort" style='width:185px;' value="<?php echo $cates['sort'] ?>" />
		   		</td>
		   	 </tr> 
		   	 <tr>
