	...
	<div class="wrap">
	  <div class="menu_list">
	      <ul>
	          ...
	          <li><a class="action" href="javascript:;">添加管理员</a></li>
	      </ul>
	  </div>
	  <form class="hd-form" onsubmit="return hd_submit(this,'<?php echo site_url('admin/add') ?>','<?php echo site_url('admin/index') ?>')">
	      <table class="hd-table hd-table-form">
	          ...
	          <tr>
	              ...
	              <select name="role">
	              		<?php foreach ($roles as $v): ?>
	                        <option value="<?php echo $v['rid'] ?>"><?php echo $v['rname'] ?></option>	
	              		<?php endforeach ?>
	              </select>
	              </td>
	          </tr>
	          ...
	          <tr>
	              ...
	              <td>
	                  ...
	                  <label><input type="radio" name="status" value="0"> 屏蔽</label>
	              </td>
	          </tr>
	      </table>
