...
<body>
	<div class="wrap">
	   <div class="menu_list">
	    <ul>
		  <li><a href="<?php echo site_url('article/art_show/'.$cid).'/?ace='.rand(100000,999999); ?>"> 内容列表 </a></li>
		  <li><a href="javascript:;" class='action'>新增</a></li> 
		</ul> 
	   </div>
	   <form action="<?php echo site_url('article/art_add'); ?>" method="post" enctype="multipart/form-data">
		   	 ...
		   	 <tr>
		   		...
		   		<select name="cid" class="w300">
		   		    ...
		   		    <?php foreach ($category as $k => $v): ?>
		   		    	<option value="<?php echo $v['cid'] ?>" <?php if($cid == $v['cid']): ?>selected='selected' <?php endif; ?>>
		   	  ...
		   	  <tr>
		   	    <th class='w100'>标题</th>
		   		<td>
		   		   <input type="text" name="title" value="" style="width:286px;"/>
		   		</td>
		   	 </tr>
		   	   <tr>
		   	     <th class='w100'>SEO-描述</th>
		   	 	<td>
		   	 	   <input type="text" name="seo_title" value="" style="width:286px;"/>
		   	 	</td>
		   	  </tr>
		   	 <tr>
		   	    <th class='w100'>概要</th>
		   		<td>
		   			<textarea name="desc" id= ""cols="45" rows="8"></textarea>
		   		</td>
		   	 </tr>  
	 		   	    ...
	 		   	    <td>
	                     <!-- 上传图片插件 -->
	 		   	 	    <div class = 'ad_upload_input'>
	 		   	 	      	<input id="catimage" type="text" name="image" readonly onmouseover='view_image(this)' src='' value="" style="width:286px;opacity:0.5" nctype="file_21">
	 		   	 	    </div>
